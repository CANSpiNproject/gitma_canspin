...
from gitma_canspin.annotation_collection import AnnotationCollection, duplicate_rows
...
def cooccurrent_annotations(
    ...
    Args:
        ac_df (pd.DataFrame): Pandas DataFrame in the format of gitma_canspin.AnnotationCollection.df .
        character_distance (int, optional): The maximal distance between two annotations considered cooccurrent. Defaults to 100.
        level (str, optional): 'Tag' or any property used in the gitma_canspin.AnnotationCollection.df with the prefix 'prop:'. Defaults to 'tag'.
...
def overlapping_annotations(
    ...
    Args:
        ac_df (pd.DataFrame): DataFrame in the format of gitma_canspin.AnnotationCollection.df
        level (str, optional): Tag' or any property used in the gitma_canspin.AnnotationCollection.df with the prefix 'prop:'. Defaults to 'tag'.
