...
from gitma_canspin.property import Property
...
class Tag:
    ...
    def __init__(self, json_file_path: str):
        ...
        #: The tag's properties as list of gitma_canspin.Property objects.
        ...
        #: Dictionary with the names of properties as keys and gitma_canspin.Propety objects as values.
        ...
        #: List of child tags as gitma_canspin.Tag objects.
        #: Is an empty list until gitma_canspin.Tag.get_child_tags is used.
        self.child_tags: List[Tag] = []

        #: Parent tag as a gitma_canspin.Tag object.
        #: Is None until gitma_canspin.Tag.get_parent_tag is used.
    ...
    def get_parent_tag(self, tagset_dict: dict) -> None:
        ...
        Args:
            tagset_dict (dict): The tagset as a gitma_canspin.Tagset.tag_dict.
        """
    ...
    def get_child_tags(self, tags: list) -> None:
        ...
        Args:
            tags (list): A list of gitma_canspin.Tag objects.
        """
        for tag in tags:
